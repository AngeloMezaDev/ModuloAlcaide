...
//consulta de informes
    public void consultarInformes(String cursoSeleccionado, String grupoSeleccionado, Date fechaInforme, JTable jTableInformeGenerado) {
        try {
            connectionBD.openConnection();
            ...
            model.setColumnIdentifiers(new Object[]{
                "ID_INFORME", "ID_DEBER", "ID_ASIGNACION", "TITULO", "FECHA_CREACION_INFO",
                "CURSO", "GRUPO", "DESCRIPCION", "RESPUESTA", "NOMBRE_AUTOR",
                "APELLIDO_AUTOR", "ID_AUTOR", "NOTA", "OBSERVACION", "ESTADO"
            });
            ...
            while (resultSet.next()) {
                ...
                model.addRow(new Object[]{
                    idInforme, idDeber, idAsignacion, titulo, fechaCreacionInfo,
                    curso, grupo, descripcion, respuesta, nombreAutor,
                    apellidoAutor, idAutor, nota, observacion, estado
                });
            }
