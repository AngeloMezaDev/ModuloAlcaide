...
--CREACION DE LA TABLA TAREAS DEL MODULO PROFESOR
CREATE TABLE Tareas (
  ID_DEBER VARCHAR2(20) PRIMARY KEY,
  ID_ASIGNACION VARCHAR2(20),
  TITULO VARCHAR2(100),
  FECHA_LIMITE DATE,
  CURSO VARCHAR2(50),
  GRUPO VARCHAR2(50),
...
--CREACION DE LA TABLA INFORMES
CREATE TABLE Informes (
  ID_INFORME VARCHAR2(10) PRIMARY KEY,
  ID_DEBER VARCHAR2(20),
  ID_ASIGNACION VARCHAR2(20),
  TITULO VARCHAR2(100),
  FECHA_CREACION_INFO DATE,
  CURSO VARCHAR2(50),
  GRUPO VARCHAR2(50),
  DESCRIPCION VARCHAR2(500),
  RESPUESTA VARCHAR2(500),
...
/* SETENCIA PARA BORRAR LOS DATOS DE TODAS LAS TABLAS
DELETE FROM asignacion;
DELETE FROM asignacionprofesor;
DELETE FROM asignacionrecluso;
DELETE FROM asistencias;
DELETE FROM deber;
DELETE FROM grupos;
DELETE FROM inscripcion;
DELETE FROM profesores;
DELETE FROM reclusos;
